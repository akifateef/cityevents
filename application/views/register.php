    ...
    <div class="row">
        <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4" style="margin-left: 32%;">
            ...
            <div align="center">
                ...
                <form class="form-login" method="POST" action="<?php echo base_url()?>admin/user/insert">
                        ...
                        <div class="form-group ">
                             ...
                             <label>First Name</label>
                                <span class="input-icon">
                                    ...
                                    <input id="email" type="text" class="form-control" name="f_name" value="" required autofocus>
                        ...
                        <div class="form-group ">
                             ...
                             <label>Last Name</label>
                                <span class="input-icon">
                                    ...
                                    <input id="email" type="text" class="form-control" name="l_name" value="" required autofocus>
